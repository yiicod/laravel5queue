...
class MongoQueue extends Queue implements QueueContract
{
    ...
    {
        return null !== $this->getTable()->findOne([
                'queue' => $queue,
    ...
    public function bulk($jobs, $data = '', $queue = null)
    {
        ...
        return $this->getTable()->insertMany($records);
    }
    ...
    protected function pushToDatabase($delay, $queue, $payload, $attempts = 0)
    {
        ...
        return $this->getTable()->insertOne($attributes);
    }
    ...
    {
        $this->getTable()->updateOne(['_id' => new MongoDB\BSON\ObjectID($id)], [
            '$set' => [
                'reserved' => 1,
    ...
    {
        return $this->database->selectDatabase()->{$this->table};
    }
